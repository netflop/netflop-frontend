...
const SignUp = () => {
  return (
    <Result
      ...
      className={tw(['[&>.ant-result-title]:text-blue-500', '[&>.ant-result-title]:text-3xl', '[&>.ant-result-subtitle]:text-xl', '[&>.ant-result-subtitle]:text-black', '[&>.ant-result-subtitle]:dark:text-white'])}
    />
  );
};
